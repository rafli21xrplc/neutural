...
<body class="overflow-hidden">
    ...
    <header>
        <nav class="bg-white border-b-2 border-green-100 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                <a href="/" class="flex items-center">
                    <img src="./leaf.png" class="mr-3 h-6 sm:h-9" alt="Flowbite Logo" />
                    <span style="color: #41644A"
                        class="self-center text-xl font-semibold whitespace-nowrap toggleColour font-work">NEUTURAL</span>
                </a>
                <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                    <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        <li>
                            <a href="/SignIn"
                                class="block py-2 pr-4 pl-3 font-light rounded bg-primary-700 lg:bg-transparent lg:text-primary-700 lg:p-0 dark:text-white"
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="relative min-h-screen flex ">
            <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 z-10">
                <div class="mr-auto place-self-center lg:col-span-7">
                    <h1
                        class="font-work max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">
                        Payments tool for software companies</h1>
                    <p
                        class="font-work max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
                        From
                    ...
                    <div class="mr-auto place-self-center lg:col-span-7 mt-8">
                        <a href="/Homepage">
                            <button type="button"
                                class="text-white bg-green-700 hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                Choose plan
