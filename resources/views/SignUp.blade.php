        ...
        <div class="relative   min-h-screen  sm:flex sm:flex-row  justify-center bg-transparent rounded-3xl shadow-xl">
            <div class="flex-col flex  self-center lg:px-14 sm:max-w-4xl xl:max-w-md  z-10">
                <div class="self-start hidden lg:flex flex-col  text-gray-300">
                    <h1 class="my-3 font-semibold text-4xl">Les't Party</h1>
                ...
                <div class="p-12 bg-white mx-auto rounded-3xl w-96 ">
                    <form action="/SignUp" method="post">
                        ...
                        <div class="mb-7">
                            ...
                            <p class="text-gray-400">have an account? <a href="/SignIn"
                                    class="text-sm text-emerald-700 hover:text-emerald-700">Sign In</a></p>
                        </div>
                        <div class="space-y-6">
                            <div class="">
                                <input
                            ...
                            <div class="relative" x-data="{ show: true }">
                                <input required name="password" placeholder="Password" :type="show ? 'password' : 'text'"
                                    class="text-sm text-gray-800 px-4 py-3 rounded-lg w-full bg-gray-200 focus:bg-gray-100 border border-gray-200 focus:outline-none focus:border-emerald-400">
